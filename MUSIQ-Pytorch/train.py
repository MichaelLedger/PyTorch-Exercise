...
config = Config({
    ...
    'db_path': '/Users/macstudio/Documents/MUSIQ-Pytorch/mnt/Dataset/anse_data/IQAdata/koniq-10k',      # root path of database
    ...
    'n_epoch': 105,                         # total training epochs: default value 100
...
weights_file_name = "epoch%d.pth" % (config.n_epoch)
weights_file = os.path.join(config.snap_path, weights_file_name)
print('will save weights of epoch {} to path: {}'.format(config.n_epoch, weights_file))
